...
import (
	...
	"github.com/sammyluck/tcp-server-demo3-with-syncpool/frame"
	"github.com/sammyluck/tcp-server-demo3-with-syncpool/metrics"
	"github.com/sammyluck/tcp-server-demo3-with-syncpool/packet"
)

/**
version 3 with syncPool 在 version 3 基础上增加 Submit结构体 池化技术
*/
